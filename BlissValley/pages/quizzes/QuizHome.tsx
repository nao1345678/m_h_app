...
export default function QuizHome({navigation}) {
  return (
    <View style={styles.container}>
        ...
        <Image source={require('../../assets/pngs/BubbleDoggo.png')} 
            style={{
                position : 'absolute',
                top: -100, 
                left : 30,
        ...
        >Quizzes can’t replace a real diagnosis. It’s always better to see a therapist.</Text>
        <PinkFlower 
            style={{
                position : 'absolute',
                bottom: 0, 
