...
export default function ADHDQuiz({ navigation }) {
  ...
  const answers = [{ never: 0 }, { rarely: 1 }, { sometimes: 2 }, { often: 3 }, { 'all the time': 4 }]
  ...
  const handleFinishQuiz = () => {
    if (currentQuestionIndex == questions.length - 1) {
      navigation.navigate('ADHD results', { selectedAnswers })
    }
  }
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <Text style={styles.generalQuestion}>
          As you answer each question, select the button that best describes how you have felt and conducted yourself
